...
import { delay, getMessageFromErrorCode } from "../../Utils";
...
const Login = () => {
  ...
  const handleLogin = async (e: any) => {
    ...
    try {
      ...
      toast.error(
        getMessageFromErrorCode(error.message, "Error ao fazer login!")
      );
    }
        ...
        >
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center bg-white text-gray-900 py-5 md:py-8 px-4">
            ...
            <form className="px-3 flex flex-col justify-center items-center w-full gap-3">
              ...
              {isLoading ? (
                <button className="flex transition-all ease-in-out justify-center items-center bg-gray-900 hover:bg-gray-600 text-white focus:outline-none focus:ring rounded px-3 py-1">
                  <svg
                  ...
                  <p className="ml-1 text-lg">Entrando...</p>
                </button>
              ) : (
                <button
                ...
                >
                  ...
                  <p className="ml-1 text-lg">Entrar</p>
                </button>
              )}
            </form>
            ...
            <p className="text-gray-700 text-sm mt-2">
              ...
              <Link href="/register" passHref>
                <a className="text-green-500 hover:text-green-600 mt-3 focus:outline-none font-bold underline">
                  cadastre-se
                </a>
              </Link>
            </p>
